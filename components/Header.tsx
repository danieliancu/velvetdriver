...
const Header = () => {
  ...
  return (
    <header className="relative top-0 left-0 right-0 p-6 md:p-8 z-50">
      ...
      <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-amber-400/50 to-transparent mt-4" />
      <div className="max-w-7xl mx-auto mt-4 flex justify-center">
        ...
        >
          ...
          <div className="text-left leading-tight login-status block">
