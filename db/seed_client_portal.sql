...
CREATE TABLE IF NOT EXISTS `client_journeys` (
  ...
  `driver_name` varchar(150) NOT NULL DEFAULT 'Pending assignment',
  `car` varchar(150) NOT NULL DEFAULT 'TBD',
  `plate` varchar(40) NOT NULL DEFAULT 'TBD',
  `status` enum('Completed','Upcoming','Cancelled','Saved') NOT NULL DEFAULT 'Upcoming',
